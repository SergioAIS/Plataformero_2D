...
// Comprobar si el jugador está cerca para activarse
if (!active) {
...
// Si no está activo, solo aplicar gravedad básica y salir
if (!active) {
    // Aplicar gravedad mínima para que caiga si está en el aire
    y_speed += grav;
    ...
    exit; // Salir del step event sin ejecutar el resto
}

// A partir de aquí, solo se ejecuta si está activo
// Aplicar gravedad
y_speed += grav;
